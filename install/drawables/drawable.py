...
class Drawable:
    def __init__(self, pos, name):
        ...
        # subclasses can optionally play animations. When they do, they must update this flag so that
        #   the state engine can see when animations finish
        self.animating = False

    def draw(self, dt, parent, offset):
        """ Updates any animations and draws this UI element and its sub-elements onto parent surface.
